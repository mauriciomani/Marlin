...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_V1_4 //BOARD_BTT_SKR_V1_3 // BOARD_RAMPS_14_EFB
#endif
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // false // Set to true to invert the logic of the probe.
...
#define HOMING_FEEDRATE_MM_M { (12*60), (12*60), (4*60) } // { (50*60), (50*60), (4*60) }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BRIGHTNESS         175 // Initial brightness (0-255)
